...
const OurProjects = () => {
	...
	return (
		<section
			ref={sectionRef}
			id='our_projects'
			className='relative mt-24 flex flex-col items-center justify-center gap-11 px-4 pb-16 pt-12 lg:pb-32 lg:pt-24'
		>
			...
			<div className='projects z-10 grid w-full max-w-[1440px] grid-cols-1 md:grid-cols-3'>
				{!isFetching && data && currentHighlight && (
					<Card className='z-20 w-[90%] rounded-[32px] border-none bg-[#050505] lg:w-full'>
						...
						{!isFetching && data && data.projectCarousel && (
							<>
								<MarqueeSlider
									...
									aspect={1}
									paddingRight={24}
									className='w-[56px] gap-4 md:w-[115px] md:gap-6'
									direction='left'
								/>
								<MarqueeSlider
